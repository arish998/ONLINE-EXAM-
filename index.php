...
echo "<h1 class='style8' align=center>Wel come to Online Exam</h1>";
		echo '<table width="280%"  border="30" align="left">
  <tr>
    <td width="17%" height="1" valign="bottom"><img src="image/HLPBUTT2.JPG" width="50" height="50" align="middle"></td>
    <td width="903%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4">Subject for Quiz </a></td>
  </tr>
  <tr>
    <td height="508" valign="bottom"><img src="image/DEGREE.JPG" width="43" height="43" align="absmiddle"></td>
...
<table width="100%" border="0">
  <tr>
    <td width="700%" height="205">&nbsp;</td>
    <td width="10%" rowspan="2" bgcolor="#CC3300"><span class="style6"></span></td>
    <td width="209%" bgcolor="#CC3333"><div align="center" class="style1">User Login </div></td>
  </tr>
  <tr>
    <td height="2906" valign="top"><div align="center">
...
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="2000" border="0">
        ...
        <tr>
          <td colspan="200"><span class="errors">
            <?php
		  if(isset($found))
		  {
        ...
        <tr>
          <td colspan="200" bgcolor="#CC3300"><div align="center"><span class="style4">New User ? <a href="signup.php">Signup Free</a></span></div></td>
          </tr>
      </table>
      <div align="center">
